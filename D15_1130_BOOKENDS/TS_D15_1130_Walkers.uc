...
// TS_D15_1130_Walkers.
//=============================================================================
class TS_D15_1130_Walkers extends TriggeredScript
	placeable;
...
Begin:
	...
	Walker06 = AnimPawn( GetPawn( 'Walker06' ));
	...
	ACTION_SetDesiredSpeed( 'Walker06', 0.25 );
	...
	PN_Walker06 = GetNavigationPoint( 'PN_Walker06' );

	ACTION_MoveToward( Walker05, PN_Walker02 );
	ACTION_MoveToward( Walker06, PN_Walker06 );
