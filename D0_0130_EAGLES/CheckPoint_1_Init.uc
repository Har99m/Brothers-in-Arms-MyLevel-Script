...
State Triggered
	{
		Begin:
				...
				//=== Show Checkpoint skybox
					ACTION_SetHidden( 'checkpoint_skybox', false );
					ACTION_SetHidden( 'Moving_SkyTerrain' , TRUE );


				//ACTION_TriggerEvent('Moving_Skybox');
		...
		//===== try killing scripts and trigs
			...
			GetFirstActor( 'LEGGY' ).bHidden = TRUE ;
			ACTION_DestroyActor( 'ByeLegBag' );
