//=============================================================================
// TS_D01_1200_SupplyDrop03Script.
//=============================================================================
class TS_D01_1200_SupplyDrop03Script extends TriggeredScript
	placeable;

var bool bDrop3Marked;
...
state Triggered
{
	...
	ACTION_DestroyActor( 'gbxTrig_Flare_03' );			// Destroy trigger
	ACTION_DestroyActor( 'WB_SupplyDrop_03' );			// Destroy beacon
	...
	// Setup Flare
	GetFirstActor('PFX_FlareThrow3').SetLocation( UUS_Ref.Grenade.Location + vect(0,0,4) );
	GetFirstActor('PFX_FlareThrow3').SetBase( UUS_Ref.Grenade );

	ACTION_PlaySound( 'PFX_FlareThrow3', "GEAR.FLARE", 1.0, 1.0, 2048 );
	ACTION_TriggerEvent( 'PFX_FlareThrow3' );				// Turn on flare
