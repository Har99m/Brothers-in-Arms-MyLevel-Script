//=============================================================================
// TS_D01_1200_SupplyDrop01Script.
//=============================================================================
class TS_D01_1200_SupplyDrop01Script extends TriggeredScript
	placeable;

var bool bDrop1Marked;
...
state Triggered
{
	...
	ACTION_DestroyActor( 'gbxTrig_Flare_01' );			// Destroy trigger
	ACTION_DestroyActor( 'WB_SupplyDrop_01' );			// Destroy beacon
	...
	// Setup Flare
	GetFirstActor('PFX_FlareThrow1').SetLocation( UUS_Ref.Grenade.Location + vect(0,0,4) );
	GetFirstActor('PFX_FlareThrow1').SetBase( UUS_Ref.Grenade );

	ACTION_PlaySound( 'PFX_FlareThrow1', "GEAR.FLARE", 1.0, 1.0, 2048 );
	ACTION_TriggerEvent( 'PFX_FlareThrow1' );				// Turn on flare
